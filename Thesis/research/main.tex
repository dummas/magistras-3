...
\begin{document}
  ...
  \input{section/ivadas.tex}

  \section{MEMS jutikliai}

  \input{section/mems_jutiklis.tex}

  \section{Signalų filtrai}

  \input{section/filtrai.tex}

  \section{Literatūros apžvalga}

  \input{section/literaturos_apzvalga.tex}

  \section{Naudojama įranga}

  \input{section/naudojama_iranga.tex}

  \section{Modelis}

  \input{section/modelis.tex}

  \section{Įgyvendinimas}

  \input{section/igyvendinimas.tex}

  \section{Išvados}

  \input{section/isvados.tex}
