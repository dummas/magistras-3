/**************************************************************************
* MPI Communication around a ring Program - C Version
* 
* DESCRIPTION:  MPI Communication around a ring example code.  C version.
...
void main(int argc, char *argv[])
{
 ...
 /*--------------------*/
  ...
  if((leftid=(myrank-1)) < 0)
  {
     leftid = nprocs-1;
  }

  if((rightid=(myrank+1)) == nprocs)
  {
     rightid = 0;
  }
